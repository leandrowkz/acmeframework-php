...
class App_User extends ACME_Module_Controller {
	...
	*/
	public function index()
	{
		...
		$this->template->load_view('_acme/app_user/index', $args);
	}
	...
	*/
	public function groups()
	{
		...
		$this->template->load_view('_acme/app_user/groups', $args);
	}
	...
	*/
	public function new_user($process = false)
	{
		...
		if( ! $process) {
			...
			$this->template->load_view('_acme/app_user/new_user', $args);
	...
	*/
	public function edit($id_user = 0, $process = false)
	{
		...
		if( ! $process) {
			...
			$this->template->load_view('_acme/app_user/edit', $args);
	...
	*/
	public function permissions($id_user = 0)
	{
		...
		// Load view
		$this->template->load_view('_acme/app_user/permissions', $args);
	}
	...
	*/
	public function profile($id_user = 0)
	{
		...
		// load view
		$this->template->load_view('_acme/app_user/profile', $args);
	}
	...
	*/
	public function edit_profile($id_user = 0, $process = false)
	{
		...
		if( ! $process) {
			...
			// load view
			$this->template->load_view('_acme/app_user/edit_profile', $args);
		} else {
	...
	*/
	public function edit_photo($id_user = 0)
	{
		...
		// load view
		$this->template->load_view('_acme/app_user/edit_photo', $args);
	}
	...
	*/
	public function change_password($id_user = 0, $process = false)
	{
		...
		if( ! $process) {
			...
			// load view
			$this->template->load_view('_acme/app_user/change_password', $args);
		} else {
