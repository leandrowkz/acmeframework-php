...
class App_Module_Manager  extends ACME_Module_Controller {
	...
	*/
	public function index()
	{
		...
		// Load view
		$this->template->load_view('_acme/app_module_manager/index', $args);
	}
	...
	*/
	public function config($id_module = 0)
	{
		...
		// Load view
		$this->template->load_view('_acme/app_module_manager/config', array('module' => $module));
	}
	...
	*/
	public function edit($id_module = 0, $process = false)
	{
		...
		if( ! $process) {
			...
			// Load view
			$this->template->load_view('_acme/app_module_manager/edit', array('module' => $module));
		} else {
	...
	*/
	public function load_area($area = '', $id_module = 0)
	{
		...
		// Load view layer
		$this->template->load_view('_acme/app_module_manager/area_' . strtolower($area), $args, false, false);
	}
