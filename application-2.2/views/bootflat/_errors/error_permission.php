...
<body style="margin:30px">
	...
	<div class="panel panel-default panel-body" style="border: 1px solid #eee">
		...
		<h3 class="hidden-lg hidden-md"><?php echo lang('Ops! You do not have permission for that')?></h3>
		<h2 class="hidden-xs hidden-sm"><?php echo lang('Ops! You do not have permission for that')?></h2>
		<h4><?php echo lang('Sorry, but your user doesn\'t has permissions for doing this action.')?></h4>
