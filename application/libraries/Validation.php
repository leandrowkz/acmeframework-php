...
class Validation {
	 ...
	 */
	public function is_date_format($value = null)
	{
		if(!is_null($value))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_date_format_db($value = null)
	{
		if(!is_null($value))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_class_name($name = null)
	{
		if(!is_null($name))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_variable_name($name = null)
	{
		if(!is_null($name))
		{
			if(preg_match("/^[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*$/", $name))
	 ...
	 * @return boolean valid
	 */
	public function is_double_($number = null)
	{
		if(!is_null($number))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_float_($number = null)
	{
		if(!is_null($number))
		{
			if(preg_match("/^-?[0-9]+(\.[0-9]+)?$/", $number))
	 ...
	 * @return boolean valid
	 */
	public function is_currency($number = null)
	{
		if(!is_null($number))
		{
			if(preg_match("/^-?[0-9]+(\,[0-9]+)?$/", $number))
	 ...
	 * @return boolean Valid
	 */
	public function is_integer_($number = null)
	{
		if(!is_null($number))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_alfa($word = null)
	{
		if(!is_null($word))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_letter($word = null)
	{
		if(!is_null($word))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_ip_v4($ip = null)
	{
		if(!is_null($ip))
		{
	 ...
	 * @return boolean valid
	 */
	public function is_roman($number = null)
	{
		if(!is_null($number))
		{
			if(preg_match("/^[MDCLXVI]+$/", $number))
			{
				return true;
			}
		}
	 ...
	 * @return boolean valid
	 */
	public function min_length($value = null, $length = null)
	{
		if(!is_null($value) && !is_null($length))
		{
			if($this->is_integer($length))
			{
	 ...
	 * @return boolean valid
	 */
	public function max_length($value = null, $length = null)
	{
		if(!is_null($value) && !is_null($length))
		{
			if($this->is_integer($length))
	 ...
	 * @return boolean valid
	 */
	public function is_hexa($hexa = null)
	{
		if($hexa != null)
		{
	 ...
	 * @return boolean valid
	 */
	public function is_special_char($word = null)
	{
		if($word != null)
		{
	 ...
	 * @return boolean valid
	 */
	public function is_hexa_color($hexa = null)
	{
		if($hexa != null)
		{
	 ...
	 * @return boolean valid
	 */
	public function is_cpf($cpf = null)
	{
		if($cpf != null)
		{
			if(preg_match("/^[0-9]{11,11}$/", $cpf))
			{
				// Basic check agains repeated numbers
					...
					($cpf == '99999999999') || ($cpf == '00000000000') )
				{
					...
					// Calculate eleventh verification digit
					$posicao = 11;
					$soma = 0;
					for ($i=0; $i<=9; $i++) {
						$soma = $soma + $digito[$i] * $posicao;
					...
					// Verify if veriication digit is equals to CPF
	 ...
	 */
	public function is_cnpj($cnpj = null)
	{
		if($cnpj != null)
		{
