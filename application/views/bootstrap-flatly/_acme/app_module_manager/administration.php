...
<div>
	...
	<div id="box_group_view">
		...
		<div class="odd">
			...
			<div id="field_view"><?php echo get_value($module, 'table_name') ?></div>
		</div>
		<div>
		...
		<div>
			...
			<div id="field_view" class="font_11">
				...
				<br />
				<strong>model:</strong>&nbsp;&nbsp;application/models/<?php echo (stristr(get_value($module, 'controller'), 'acme_')) ? 'acme/' . strtolower(DB_DRIVER) . '/' : '';?><?php echo get_value($module, 'controller') ?>_model.php
				<br />
