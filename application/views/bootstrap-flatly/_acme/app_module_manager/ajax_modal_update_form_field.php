...
<body>
	...
	<?php if($error || get_value($field, 'dtt_inative') != '' || count($field) <= 0) { ?>
		<?php echo message('warning', lang('Atenção!'), lang('O campo que você está tentando editar ainda não foi marcado para uso. Selecione o checkbox correspondente ao campo e tente novamente.')); ?>
	...
	<?php } else if(get_value($field, 'form_inative') == 'S' || get_value($field, 'form_inative') == '') {?>
		<?php echo message('warning', lang('Atenção!'), lang('O formulário deste campo está inativo. Habilite o uso deste formulário selecionando o checkbox e tente novamente.')); ?>
		<div style="margin-top:35px">
			<hr />
			<div style="margin:10px 3px 0 0" class="inline top"><button onclick="parent.close_modal()"><?php echo lang('ok')?></button></div>
			<div style="margin:18px 0px 0 0" class="inline top">ou <a href="javascript:void(0);" onclick="parent.close_modal();"><?php echo lang('cancelar') ?></a></div>
	...
	<?php } else { ?>
		...
		<?php echo message('info', '', lang('Utilize o formulário abaixo para editar os dados do campo selecionado. Campos com (*) são obrigatórios.')) ?>
		
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_module_manager/ajax_modal_update_form_field_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field">
					<input type="text" name="table_column" id="table_column" class="validate[required]" <?php echo (get_value($field, 'operation') == 'filter') ? '' : 'disabled="disabled"' ?> value="<?php echo get_value($field, 'table_column') ?>" style="width:150px" />
						<?php if(get_value($field, 'operation') == 'filter'){ ?>
						...
						<?php } else { ?>
						<div class="font_11" style="margin:7px 0 0 0;width:450px;"><span class="font_warning"><?php echo lang('Atenção! Alterar o nome da coluna deste campo fará com que o campo deixe de aparecer na listagem de campos deste formulário. Recomendamos a alteração apenas caso existam alterações físicas na tabela.') ?></span> <a href="javascript:void(0)" onclick="enable_column_name_field();">Estou ciente, quero liberar a edição deste campo</a></div>
						<?php } ?>
				</div>
			</div>
			<div id="form_line">
				...
				<div class="form_field">
					<select name="type" id="type" class="validate[required]" style="width:162px">
						<option value="text" <?php echo (get_value($field, 'type') == 'text') ? 'selected="selected"' : ''; ?>>text</option>
						...
						<option value="password" <?php echo (get_value($field, 'type') == 'password') ? 'selected="selected"' : ''; ?>>password</option>
					</select>
				</div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Rótulo de Exibição')?>*</div>
				<div class="form_field"><input type="text" name="lang_key_label" id="lang_key_label" class="validate[required]" value="<?php echo get_value($field, 'lang_key_label') ?>" style="width:150px" /></div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Descrição')?></div>
				<div class="form_field">
					<input type="text" name="description" id="description" value="<?php echo get_value($field, 'description') ?>" style="width:150px" />
					<div class="comment font_11" style="margin:7px 0 0 0;width:450px;"><?php echo lang('A descrição do campo aparecerá como um texto informativo abaixo do campo.') ?></div>
				</div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Ordenação')?></div>
				<div class="form_field">
					<input type="text" name="order_" id="order_" value="<?php echo get_value($field, 'order_') ?>" alt="integer" class="validate[integer]" style="width:100px" />
			...
			<div id="form_line">
				...
				<div class="form_field"><input type="text" name="id_html" id="id_html" class="validate[required]" value="<?php echo get_value($field, 'id_html') ?>" style="width:150px" /></div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Classe HTML')?></div>
				<div class="form_field"><input type="text" name="class_html" id="class_html" value="<?php echo get_value($field, 'class_html') ?>" style="width:150px" /></div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Maxlength')?></div>
				<div class="form_field"><input type="text" name="maxlength" id="maxlength" value="<?php echo get_value($field, 'maxlength') ?>" style="width:150px" /></div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Estilos (style)')?></div>
				<div class="form_field">
					<textarea name="style" id="style" style="width:250px;height:80px"><?php echo get_value($field, 'style') ?></textarea>
			...
			<div id="form_line">
				...
				<div class="form_field">
					<textarea name="javascript" id="javascript" style="width:250px;height:80px"><?php echo get_value($field, 'javascript') ?></textarea>
			...
			<div id="form_line">
				...
				<div class="form_field">
					<textarea name="options_sql" id="options_sql" class="script" style="width:250px;height:80px"><?php echo get_value($field, 'options_sql') ?></textarea>
			...
			<div id="form_line">
				...
				<div class="form_field">
					<textarea name="options_rotules" id="options_rotules" style="width:250px;height:80px"><?php echo get_value($field, 'options_rotules') ?></textarea>
			...
			<div id="form_line">
				...
				<div class="form_field">
					<textarea name="options_values" id="options_values" style="width:250px;height:80px"><?php echo get_value($field, 'options_values') ?></textarea>
			...
			<div id="form_line">
				...
				<div class="form_field">
					<textarea name="masks" id="masks" style="width:250px;height:80px"><?php echo get_value($field, 'masks') ?></textarea>
			...
			<div id="form_line">
				...
				<div class="form_field">
					<textarea name="validations" id="validations" style="width:250px;height:80px"><?php echo get_value($field, 'validations') ?></textarea>
					<div class="comment font_11" style="margin:7px 0 0 0;width:450px;">
