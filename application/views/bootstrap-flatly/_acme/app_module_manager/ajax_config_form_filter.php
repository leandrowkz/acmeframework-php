			...
			<div>
				...
				<div id="field_view" style="max-width:2000px;min-width:300px;">
					...
					<div class="font_11" id="instrucoes_form_filter" style="display:none;">					
						...
						<div><?php echo lang('3) Habilite os campos que este formulário possuirá. Estes campos estão localizados na seção <strong>Campos do Formulário</strong> e referenciam a tabela do módulo (tabela: ') . ' <strong>' . $table_name . '</strong>).' ?> </div>
