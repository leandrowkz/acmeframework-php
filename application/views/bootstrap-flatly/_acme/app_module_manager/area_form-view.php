...
<ul class="nav nav-tabs" style="margin-top: 20px">
    <li class="active"><a href="#form-insert" data-toggle="tab"><?php echo lang('Inserção') ?></a>
    </li>
    <li><a href="#form-edit" data-toggle="tab"><?php echo lang('Edição') ?></a>
    </li>
    <li><a href="#form-delete" data-toggle="tab"><?php echo lang('Deleção') ?></a>
    </li>
    <li><a href="#form-view" data-toggle="tab"><?php echo lang('Visualização') ?></a>
    </li>
</ul>
