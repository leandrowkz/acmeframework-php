...
<body>
	<div id="modal_content">
		...
		<?php echo message('info', '', lang('Utilize o formulário abaixo para editar a permissão selecionada. Campos com (*) são obrigatórios.')) ?>
		
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_module_manager/ajax_modal_module_permission_update_process" method="post">
			<input type="hidden" name="id_module_permission" id="id_module_permission" value="<?php echo get_value($data, 'id_module_permission') ?>" />
			...
			<div id="form_line">
				...
				<div class="form_field"><input type="text" name="lang_key_rotule" id="lang_key_rotule" value="<?php echo get_value($data, 'lang_key_rotule') ?>" class="validate[required]" style="width:300px;" /></div>
			</div>
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="permission" id="permission" value="<?php echo get_value($data, 'permission') ?>" style="width:120px;" class="validate[required,custom[onlyLetterNumberChrSpecials]]" />
					<div class="font_error font_11 bold" style="margin-top:5px"><?php echo lang('ATENÇÃO! Alterar o nome da permissão implicará na necessidade de atualizar os arquivos que utilizam sua validação') ?></div>
			...
			<div id="form_line">
				...
				<div class="form_field"><textarea name="description" id="description" style="width:400px;height:100px"><?php echo get_value($data, 'description') ?></textarea></div>
			</div>
			<div id="form_line">
