...
<body>
	<div id="modal_content">
		...
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_module_manager/ajax_modal_module_menu_update_process" method="post">
			<input type="hidden" name="id_module_menu" id="id_module_menu" value="<?php echo get_value($data, 'id_module_menu') ?>" />
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px;"><input type="text" name="link" id="link" value="<?php echo htmlentities(get_value($data, 'link')) ?>" style="width:300px;" class="validate[required]" /></div>
			</div>
			<div id="form_line">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="order_" id="order_" value="<?php echo get_value($data, 'order_')?>" class="validate[required]" alt="integer" style="width:50px;" />
