...
<body>
	<div id="modal_content">
		...
		<?php echo message('warning', lang('ATENÇÃO!'), lang('O menu de módulo que está sendo visualizada será deletado. Para confirmar a deleção, clique em <strong>ok</strong>, caso contrário clique em <strong>cancelar</strong>.')) ?>
		
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_module_manager/ajax_modal_module_menu_delete_process" method="post">
			...
			<div id="box_group_view">
				<div class="odd">
					...
					<div id="field_view"><?php echo get_value($data, 'id_module_menu') ?></div>
				</div>
				<div>
