...
<div>
	...
	<div id="module_header">
		...
		<div id="module_menus" class="inline top">
			<div class="inline top module_menu_item" title="<?php echo lang('Edição')?>" style="margin:-7px 0 0 -15px">
				<h4 class="inline top font_shadow_gray"> > <?php echo lang('Edição de Registro') ?></h4>
	...
	<!-- DESCRICAO DO FORM -->
	<div id="module_description" style="line-height:normal;"><?php echo message('info', '', lang('Utilize o formulário abaixo para editar os dados do registro que está sendo visualizado. Campos com (*) são obrigatórios.')) ?></div>
