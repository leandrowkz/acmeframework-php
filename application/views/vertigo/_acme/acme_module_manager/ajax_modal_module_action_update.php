...
<body>
	<div id="modal_content">
		...
		<?php echo message('info', '', lang('Utilize o formulário abaixo para editar a ação de registro selecionada. Campos com (*) são obrigatórios.')) ?>
		
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_module_manager/ajax_modal_module_action_update_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px;">
					<input type="text" name="link" id="link" value="<?php echo htmlentities(get_value($data, 'link')) ?>" style="width:300px;" class="validate[required]" />
