	...
	<div id="modal_content">
		...
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_module_manager/ajax_modal_update_module_data_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field"><input type="text" name="table_name" id="table_name" value="<?php echo get_value($module, 'table_name')?>" style="width:170px;" /></div>
			</div>
			<div id="form_line">
			...
			<div id="form_line">
				...
				<div class="form_field">
					<textarea name="sql_list" id="sql_list" class="script" style="width:400px;height:170px"><?php echo get_value($module, 'sql_list')?></textarea>
					<?php if(strtolower(DB_DRIVER) == 'oci8'){?>
					<div class="font_11 font_error" style="margin-top:5px;"><?php echo lang("ATENÇÃO! Consultas SQL no Oracle não podem ser finalizadas com o caracter ';'.") ?></div>
					<?php } ?>
				</div>
			</div>
			<div id="form_line">
