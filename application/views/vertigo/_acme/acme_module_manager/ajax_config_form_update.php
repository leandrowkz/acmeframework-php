			...
			<div>
				...
				<div id="field_view" style="max-width:2000px;min-width:300px;">
					...
					<div class="font_11" id="instrucoes_form_update" style="display:none;">					
						...
						<div><?php echo lang('&bull;&nbsp;A ação básica deste formulário é permitir a edição de um registro da tabela do módulo selecionado (tabela: ') . ' <strong>' . $table_name . '</strong>).' ?></div>
