...
<body>
	<div id="modal_content">
		...
		<?php echo message('info', '', lang('Utilize o formulário abaixo para adicionar um novo menu para este módulo. Campos com (*) são obrigatórios.')) ?>
		
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_module_manager/ajax_modal_module_menu_new_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px;"><input type="text" name="link" id="link" value="" style="width:300px;" class="validate[required]" /></div>
			</div>
			<div id="form_line">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="order_" id="order_" value="" class="validate[required]" alt="integer" style="width:50px;" />
