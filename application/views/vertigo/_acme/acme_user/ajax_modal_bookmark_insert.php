...
<body>
	<div id="modal_content">
		...
		<?php echo message('info', '', lang('Utilize o formulário abaixo para adicionar um novo favorito para o usuário') . ' <strong>' . get_value($user, 'login') . '</strong>. ' . lang('Campos com (*) são obrigatórios.')) ?>
		
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/acme_user/ajax_modal_bookmark_insert_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:auto;">
					<input type="text" name="name" id="name" value="" class="validate[required]" style="width:200px;" />
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:auto;">
					<input type="text" name="link" id="link" value="" style="width:200px;" class="validate[required]" />
				</div>
			</div>
