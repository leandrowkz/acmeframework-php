<div>
	...
	<div id="module_header">
		...
		<div id="module_menus" class="inline top">
			<div class="inline top module_menu_item" title="<?php echo lang('Deleção')?>" style="margin:-7px 0 0 -15px">
				<h4 class="inline top font_shadow_gray"> > <?php echo lang('Deleção de Registro') ?></h4>
	...
	<!-- DESCRICAO DO FORM -->
	<div id="module_description" style="line-height:normal;"><?php echo message('warning', lang('Atenção!'), lang('O registro que está sendo visualizado será deletado. para continuar clique em <strong>ok</strong>, para desistir clique em <strong>cancelar</strong>.')) ?></div>
		...
		<form id="form_default" name="form_default" action="<?php echo $action ?>" method="<?php echo $method ?>" <?php echo $enctype ?>>
			...
			<div id="box_group_view">
				...
				<div <?php echo $class ?>>
					...
					<div id="field_view"><?php echo get_value($values, get_value($field, 'table_column'))?></div>
				</div>
				<?php $i++; } ?>
			</div>
