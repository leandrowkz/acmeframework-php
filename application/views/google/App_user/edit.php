...
<div class="module-body">
	...
	<div class="row">
		...
		<div class="col-sm-12" style="margin-bottom: 15px"><?php echo message('warning', lang('Attention!'), lang('You are not able to edit ROOT users at this time. Go to') . ' <strong>controllers/App_User.php</strong> ' . lang('and change the attribute') . ' <code>$protect_root_users</code> ' . lang('from') . ' <strong>TRUE</strong> ' . lang('to') . ' <strong>FALSE</strong>.') ?></div>

		<?php
		} else {
			$action = ' action="' . URL_ROOT . '/app-user/edit/' .  get_value($user, 'id_user') . '/true"';
			$disabled = ' ';
			$method = ' method="post"';
		}
		?>
