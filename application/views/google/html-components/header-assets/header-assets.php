...
<script src="<?php echo URL_CSS ?>/todc-bootstrap/js/bootstrap.min.js"></script>

<!-- App Scripts - Include with every page -->
<script src="<?php echo URL_JS ?>/app-functions.js"></script>

<!-- CSS Assets - Include with every page -->
<link href="<?php echo URL_CSS ?>/todc-bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
<link href="<?php echo URL_CSS ?>/todc-bootstrap/css/todc-bootstrap.min.css" rel="stylesheet" type="text/css" />
