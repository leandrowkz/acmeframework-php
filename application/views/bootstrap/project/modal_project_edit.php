...
<body>
	<div id="modal_content">
		...
		<?php echo message('info', '', '<span class="font_11">' . lang('Utilize o formulário abaixo para editar os dados do projeto selecionado. Campos com (*) são obrigatórios') . '</span>') ?>
		...
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/project/modal_project_edit_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="title" id="title" value="<?php echo get_value($project, 'title')?>" class="validate[required]" style="width:300px;" />
				</div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Descrição do Projeto')?></div>
				<div class="form_field" style="width:400px">
					<textarea name="description" id="description" style="width:300px;height:100px"><?php echo get_value($project, 'description')?></textarea>
				</div>
			</div>
			<div id="form_line">
				...
				<div class="form_field" style="width:550px">
					<input type="text" name="hour_value" id="hour_value" value="<?php echo number_format(get_value($project, 'hour_value'), 2, ',', '.')?>" alt="decimal" class="validate[required]" style="width:70px;" maxlength="10" />
