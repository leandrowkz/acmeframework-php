...
<body>
	...
	<div id="modal_content">
		...
		<h6 style="margin:30px 0 0 0"><?php echo lang('Histórico / Andamento da Tarefa') ?></h6>
		<hr style="margin-bottom:15px" />
		<?php if(strtolower(get_value($task, 'situation')) != 'finalizada') { ?>
		<div style="float:right;margin:-47px 0 0 0"><button class="green mini-control" onclick="show_area_slide('box-new-history')"><?php echo lang('Inserir Andamento')?></button></div>
		<?php } ?>
		
		<!-- CAIXA ONDE FICARÃO COMENTÁRIOS/ANDAMENTOS/HISTÓRICO  -->
		<div id="box-history-<?php echo get_value($task, 'id_task') ?>"></div>
