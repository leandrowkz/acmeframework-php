...
<body>
	<div id="modal_content">
		...
		<?php echo message('info', '', '<span class="font_11">' . lang('Utilize o formulário abaixo para adicionar uma nova tarefa para a atividade') . ' <strong>' . get_value($activity, 'title') . '</strong>. ' . lang('Campos com (*) são obrigatórios.') . '</span>') ?>
		
		<!-- FORMULARIO -->
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/task/modal_task_new_process" method="post">
			...
			<div id="form_line">
				...
				<div class="form_field font_blue" style="width:400px;padding-top:-1px"><h6><?php echo get_value($project, 'title'); ?> > <?php echo get_value($activity, 'title'); ?></h6></div>
			</div>
			<div id="form_line">
				...
				<div class="form_field" style="width:400px">
					<input type="text" name="title" id="title" value="" class="validate[required]" style="width:350px;" />
				</div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Descrição')?></div>
				<div class="form_field" style="width:400px">
					<textarea name="description" id="description" style="width:350px;height:120px"></textarea>
				</div>
			</div>
			<div id="form_line">
				...
				<div class="form_field" style="min-width:400px">
					<select name="id_user_responsible" id="id_user_responsible" style="width:300px;" class="validate[required]"><?php echo $options_users; ?></select>
			...
			<div id="form_line">
				...
				<div class="form_field" style="min-width:400px">
					<select name="id_user_executor" id="id_user_executor" style="width:300px;" class="validate[required]"><?php echo $options_users; ?></select>
			...
			<div id="form_line">
				...
				<div class="form_field" style="min-width:400px">
					<select name="priority" id="priority" style="width:91px;" class="validate[required]">
						<option value="baixa"><?php echo lang('Baixa')?></option>
						<option value="normal" selected="selected"><?php echo lang('Normal')?></option>
						<option value="alta"><?php echo lang('Alta')?></option>
					</select>
				</div>
			</div>
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Estimativa')?>*</div>
					<div class="form_field" style="min-width:400px">
					<input type="text" name="estimate" id="estimate" value="" alt="time" class="validate[required]" style="width:79px;" maxlength="5" />
			...
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Previsão de Início')?>*</div>
					<div class="form_field" style="min-width:400px">
					<input type="text" name="ini_prev" id="ini_prev" value="" alt="date" class="validate[required,custom[date]]" style="width:79px;" maxlength="10" />
			...
			<div id="form_line">
				<div class="form_label font_11 bold" style="width:150px"><?php echo lang('Previsão de Término')?>*</div>
					<div class="form_field" style="min-width:400px">
					<input type="text" name="end_prev" id="end_prev" value="" alt="date" class="validate[required,custom[date]]" style="width:79px;" maxlength="10" />
