...
<div>
	...
	<div id="module_header">
		...
		<div id="module_menus" class="inline top">
			<div id="module_menus" class="inline top">
			<div class="inline top module_menu_item" title="<?php echo lang('Detalhes da Tarefa')?>" style="margin:-19px 0 0 -15px">
				<h4 class="inline top font_shadow_gray"> > <?php echo lang('Detalhes da Tarefa') ?></h4>
	...
	<h5 class="inline top" style="margin:40px 0 0 0"><?php echo lang('Histórico da Tarefa') ?></h5>
	<hr />
	
	<!-- CAIXA ONDE FICARÃO COMENTÁRIOS/ANDAMENTOS/HISTÓRICO  -->
	<div id="box-history-<?php echo get_value($task, 'id_task')?>" style="background-color:#f5f5f5;padding:15px 15px;border-bottom:1px solid #ccc;"></div>
