...
<div>
	...
	<div id="module_header">
		...
		<div id="module_menus" class="inline top">
			<div id="module_menus" class="inline top">
			<div class="inline top module_menu_item" title="<?php echo lang('Reabrir Tarefa')?>" style="margin:-19px 0 0 -15px">
				<h4 class="inline top font_shadow_gray"> > <?php echo lang('Reabrir Tarefa') ?></h4>
	...
	<?php echo message('warning', lang('ATENÇÃO!'), lang('Esta tarefa está prestes a ser reaberta. Insira abaixo uma mensagem de reabertura. Após a postagem, a tarefa será reaberta e encaminhada para o último executor') . ' (<strong>' . get_value($task, 'login_executor') . '</strong>).');?>
	<div style="margin-top:20px">
		...
		<div class="box-comment-new inline top font_11">
			...
			<div style="border-top:1px dashed #ccc;margin:5px 0;padding-top:5px;">
				...
				-->
				<button class="mini-control green" style="float:right;" onclick="javascript:if(ajax_post_comment_history_reopen()==true){redirect('<?php echo URL_ROOT . $url_redirect?>')}"><?php echo lang('Postar') ?></button>
			</div>
		</div>
	</div>
