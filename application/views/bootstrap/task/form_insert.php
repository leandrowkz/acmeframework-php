...
<div>
	...
	<div id="module_header">
		...
		<div id="module_menus" class="inline top">
			<div class="inline top module_menu_item" title="<?php echo lang('Inserção')?>" style="margin:-7px 0 0 -15px">
				<h4 class="inline top font_shadow_gray"> > <?php echo lang('Nova Tarefa') ?></h4>
	...
	<div style="margin-top:30px">
		<form id="form_default" name="form_default" action="<?php echo URL_ROOT ?>/task/form_insert_process" method="post">
			...
			<div id="form_line" class="odd" style="padding-top:15px;">
				...
				<div class="form_field"><input type="text" name="title" id="title" class="validate[required]" maxlength="250" style="width:300px" /></div>
			</div>
			<div id="form_line">
			...
			<div id="form_line" class="odd">
				...
				<div class="form_field"><select name="id_activity" id="id_activity" style="width:312px" class="validate[required]"><option><?php echo lang('Selecione um projeto')?></option></select></div>
			</div>
			<div id="form_line" class="odd">
				...
				<div class="form_field" style="min-width:400px">
					<select name="id_user_responsible" id="id_user_responsible" style="width:312px;" class="validate[required]"><?php echo $options_users; ?></select>
			...
			<div id="form_line">
				...
				<div class="form_field" style="min-width:400px">
					<select name="id_user_executor" id="id_user_executor" style="width:312px;" class="validate[required]"><?php echo $options_users; ?></select>
			...
			<div id="form_line" class="odd" style="padding-top:15px;">
				...
				<div class="form_field"><textarea name="description" id="description" style="width:200px;height:100px;"></textarea></div>
			</div>
