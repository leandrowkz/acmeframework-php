...
<body>
	...
	<div id="modal_content">
		...
		<div id="box-finalize">
			...
			<h6 class="inline top" style="margin:30px 0 0 0"><?php echo lang('Mensagem de Reabertura da Tarefa') ?></h6>
			...
			<?php echo message('warning', '<span class="font_16">' . lang('ATENÇÃO!') . '</span>', '<span class="font_11">' . lang('Esta tarefa está prestes a ser reaberta. Insira abaixo uma mensagem de reabertura. Após a postagem, a tarefa será reaberta e encaminhada para o último executor') . ' (<strong>' . get_value($task, 'login_executor') . '</strong>).</span>');?>
			<div style="margin-top:20px;">
				...
				<div class="box-comment-new inline top font_11">
					...
					<div style="border-top:1px dashed #ccc;margin:5px 0;padding-top:5px;">
						...
						<input type="hidden" id="time" alt="time" value="00:00" />
						<!--
						<div class="inline top comment" style="margin:3px 0 0 5px">
							<div><?php echo lang('Informe o tempo utilizado neste andamento') ?>.</div>
						</div>
						-->
						<button class="mini-control green" style="float:right;" onclick="ajax_post_comment_history_reopen()"><?php echo lang('Postar') ?></button>
					</div>
				</div>
			</div>
		...
		<div id="msg-finalize" class="font_11" style="display:none;"><?php echo message('success', lang('Feito!'), lang('Tarefa reaberta com sucesso! Clique ') . '<a href="javascript:void(0);" onclick="parent.close_modal();">' . lang('aqui') . '</a> ' . lang('para fechar essa janela.')) ?></div>
