    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
				...
				"cpf": {
                    "regex": /^([0-9]{3,3}[\.])([0-9]{3,3}[\.])([0-9]{3,3}[\-])([0-9]{2,2})$/,
                    "alertText": "* Formato de CPF inválido"
                },
				"cnpj": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^([0-9]{2,2}[\.])([0-9]{3,3}[\.])([0-9]{3,3}[\/])([0-9]{4,4}[\-])([0-9]{2,2})$/,
                    "alertText": "* Formato de CNPJ inválido"
                },
                "email": {
				...
				"date-es_ES":{
					...
					"alertText":"* Data inválida, deve estar no formato DD/MM/AAAA"
				},
				"date-pt_BR":{
					"regex": /^(((0[1-9]|[12]\d|3[01])\/(0[13578]|1[02])\/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)\/(0[13456789]|1[012])\/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])\/02\/((19|[2-9]\d)\d{2}))|(29\/02\/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$/,
					"alertText":"* Data inválida, deve estar no formato DD/MM/AAAA"
				...
				"onlyLetterNumberChrSpecials": {
                    "regex": /^[0-9a-zA-Z\.\_]+$/,
                    "alertText": "* Só é permitido letras, números, pontos ou underscores"
                },
				...
				"verify_login": {
					"url": $('#URL_ROOT').val() + "/acme_user/verify_login",
					"alertText": "* Já existe um usuário com este login",
					"alertTextOk": "Tudo certo!",
					"alertTextLoad": "* Validando, aguarde por favor"
					/*
					"extraData": "name=eric",
