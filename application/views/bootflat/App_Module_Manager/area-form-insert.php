...
<div style="margin: 30px 0 0 2px">
    ...
    <h4 style="margin-left: 1px"><?php echo lang('Form INSERT') ?></h4>
    ...
    <div class="well">
        ...
        <div style="margin: 0 0 20px">
            ...
            <div class="inline" style="width: 150px">
                <label><?php echo lang('Linked menu') ?> </label>
                <i class="fa fa-question-circle fa-fw" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo lang('A module menu that points to this form') ?>"></i>
            </div>

            <div class="inline activate-menu">
                ...
                <label class="toggle inline">
                    <input type="checkbox" class="enable-menu" <?php echo $checked ?> />
                    <span class="handle"></span>
                </label>
...
<div class="table-responsive">
    ...
    <table class="table table-bordered" id="table-fields-insert">
        ...
        <tbody>
            ...
            <tr id="tr-<?php echo $i ?>">
                ...
                <td style="width: 01%">
                    <div class="checkbox" data-toggle="tooltip" data-placement="bottom" data-original-title="<?php echo lang('Enable/disable field') ?>">
...
<style>
    ...
    #table-fields-insert { margin: 0 !important ;}
...
<script>
    ...
    // =====================================================================
    // Callback ajax complete (after enable field, enable form, enable menu)
    // =====================================================================
    ...
    // =================================
    // Click enable menu checkbox toggle
    // =================================
    $('.enable-menu').click( function () {

        // Get operation
        var oper = $(this).is(':checked') ? 'enable-menu-form-insert' : 'disable-menu-form-insert';

        // Ajax to save this
        $.enable_loading();

        $.ajax({
            url: $('#URL_ROOT').val() + '/app-module-manager/save-menu/' + oper,
            context: document.body,
