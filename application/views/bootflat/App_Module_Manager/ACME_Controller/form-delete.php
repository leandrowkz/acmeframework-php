		...
		<div class="col-sm-12">
			...
			<form action="<?php echo $action ?>" method="<?php echo $method ?>" <?php echo $enctype ?>>
				...
				<div style="margin-bottom: 30px">
					...
					<?php echo message('warning', '<i class="fa fa-fw fa-warning"></i> ' . lang('Warning!'), lang('The following record will be deleted. If you are right about this, click on OK button.')) ?>
	            ...
	            <div class="form-footer">
	                <button class="btn btn-warning" type="submit"><?php echo lang('Delete') ?> <i class="fa fa-fw fa-trash"></i></button>
