...
<div style="margin: 30px 0 0 2px">
    ...
    <h4 style="margin-left: 1px"><?php echo lang('Form DELETE') ?></h4>
...
<div class="table-responsive">
    ...
    <table class="table table-bordered" id="table-fields-delete">
...
<style>
    ...
    #table-fields-delete { margin: 0 !important ;}
...
<script>
    ...
    $('.enable-action').click( function () {
        ...
        // Get operation
        var oper = $(this).is(':checked') ? 'enable-action-form-delete' : 'disable-action-form-delete';

        // Ajax to save this
        $.enable_loading();

        $.ajax({
            url: $('#URL_ROOT').val() + '/app-module-manager/save-action/' + oper,
            context: document.body,
