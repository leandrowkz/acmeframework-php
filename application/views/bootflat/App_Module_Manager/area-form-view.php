...
<div style="margin: 30px 0 0 2px">
    ...
    <h4 style="margin-left: 1px"><?php echo lang('Form VIEW') ?></h4>
...
<div class="table-responsive">
    ...
    <table class="table table-bordered" id="table-fields-view">
...
<style>
    ...
    #table-fields-view { margin: 0 !important ;}
