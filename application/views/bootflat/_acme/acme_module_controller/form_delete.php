...
<div class="row">
	...
	<?php echo message('warning', lang('Atenção!'), lang('O registro visualizado será deletado. Para confirmar, clique em OK')) ?>
		...
		<form action="<?php echo $action ?>" method="<?php echo $method ?>" <?php echo $enctype ?>>
            ...
            <div class="row bottom-group-buttons">
	            <div class="col-sm-12">
	                ...
	                <a class="btn btn-default" href="<?php echo URL_ROOT ?>/<?php echo $this->controller ?>"><?php echo lang('Cancelar') ?></a>
	            </div>
	        </div>
