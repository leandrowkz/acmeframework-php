        ...
        <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
            ...
            <div class="btn-group pull-right clearfix">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo URL_ROOT ?>/app-user/new-user"><i class="fa fa-user fa-fw"></i> <?php echo lang('New user')?></a></li>
                    <li><a href="<?php echo URL_ROOT ?>/app-user/groups"><i class="fa fa-group fa-fw"></i> <?php echo lang('Groups')?></a></li>
        ...
        <div class="col-sm-12">
            ...
            <div class="top list-user-info" style="margin: 2px 0 0 135px;">
                ...
                <div style="margin-top: 10px">
                    ...
                    <a href="<?php echo URL_ROOT ?>/app-user/edit/<?php echo $id_user ?>" class="btn btn-xs btn-primary" style="margin: 0 5px 5px 0">
                        <i class="fa fa-edit fa-fw"></i>
                        <?php echo lang('Edit') ?>
                    </a>

                    <a href="<?php echo URL_ROOT ?>/app-user/permissions/<?php echo $id_user ?>" class="btn btn-xs btn-primary" style="margin: 0 5px 5px 0">
