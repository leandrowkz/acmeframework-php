...
/**
*
* Classe Acme_Access_Model
*
* Abstração da camada modelo (banco de dados) para acesso ao sistema.
* 
* @since		04/10/2012
* @location		acme.models.acme_access_model
*
*/
class Acme_Access_Model extends Base_Module_Model {
	...
	*/
	public function browser_rank()
	{
		...
		// Define a consulta conforme o tipo de banco
	...
	*/
	...
	{
		$sql = "SELECT IFNULL(COUNT(*), 0) AS PERMISSION 
