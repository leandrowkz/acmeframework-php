...
/**
 * Builds a set of HTML tags <option> from a resultset array. This array
 * must has two indexes, the first one is value will be placed on value
 * attribute and the second one must be the label will be placed on option.
 *
 * Take an example:
 * Array
 * (
