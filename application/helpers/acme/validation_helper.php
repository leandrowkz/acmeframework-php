...
* Validation Helper
*
* Centraliza funções quanto a validação em geral de dados na aplicação, que estarão disponíveis 
* em todo controlador derivado de Acme_Core_Controller.
*
* A chamada das funções contidas neste arquivo ajudante são alias para os métodos de mesmo nome
* localizados na respectiva biblioteca (Validation). Sendo assim, as instruções abaixo retornam o mesmo
* resultado esperado:
*	example_function(); // função localizada neste arquivo
* 	$this->validation->example_function();
* 
* @since		24/02/2012
* @location		acme.helpers.validation
* -------------------------------------------------------------------------------------------------
*/
...
* @return boolean valid
*/
function is_equal($valor_one = null, $valor_two = null)
{
...
* @return boolean valid
*/
function length($value = null, $length_ini = null, $length_end = null)
{
...
* @return boolean valid
*/
function between($number = null, $length_ini = null, $length_end = null)
{
